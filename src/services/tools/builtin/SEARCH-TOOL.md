...
| `you` | 可选 | 100/天 | AI 搜索，无需注册 |
| `brave` | 必需 | ~1000/月 | $5 免费额度，质量最高 |
| `tavily` | 必需 | 1000/月 | AI 优化搜索，延迟最低 |
| `exa` | 必需 | 1000/月 | 语义搜索，适合技术内容 |
| `serpapi` | 必需 | 100/月 | Google 搜索，结果全面 |
| `bing` | 必需 | 已退役 | 微软搜索，已停止服务 |
| `google` | 必需 | 已关闭 | Google 官方 API，已关闭注册 |
